 ...
 */
final class Version20220917145656 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE images_voitures (id INT AUTO_INCREMENT NOT NULL, voiture_id INT DEFAULT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_287B4D71181A8BA (voiture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE prix (id INT AUTO_INCREMENT NOT NULL, voiture_id INT DEFAULT NULL, date_debut_s1 VARCHAR(10) NOT NULL, prix_s1 DOUBLE PRECISION NOT NULL, date_debut_s2 VARCHAR(10) NOT NULL, prix_s2 DOUBLE PRECISION NOT NULL, date_debut_s3 VARCHAR(10) NOT NULL, prix_s3 DOUBLE PRECISION NOT NULL, date_debut_s4 VARCHAR(10) NOT NULL, prix_s4 DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_F7EFEA5E181A8BA (voiture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, id_voiture_id INT NOT NULL, lieu_prise VARCHAR(255) NOT NULL, lieu_reprise VARCHAR(255) NOT NULL, date_prise DATE NOT NULL, date_reprise DATE NOT NULL, heure_prise VARCHAR(255) NOT NULL, heure_reprise VARCHAR(255) NOT NULL, code VARCHAR(50) DEFAULT NULL, prix_total DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_42C8495577153098 (code), INDEX IDX_42C84955A40B286D (id_voiture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE voiture (id INT AUTO_INCREMENT NOT NULL, marque_id INT NOT NULL, carburant VARCHAR(255) NOT NULL, transmission VARCHAR(255) NOT NULL, puissance INT NOT NULL, annee INT NOT NULL, categorie VARCHAR(255) NOT NULL, agence VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, prix_jour DOUBLE PRECISION NOT NULL, code VARCHAR(255) NOT NULL, INDEX IDX_E9E2810F4827B9B2 (marque_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE images_voitures ADD CONSTRAINT FK_287B4D71181A8BA FOREIGN KEY (voiture_id) REFERENCES voiture (id)');
